...
const config: SiteConfig = {
  ...
  socialLinks: {
    github: 'https://https://github.com/coycatrett',
  ...
  giscus: {
    ...
    repoId: 'R_kgDOQtP2xA', // 'R_kgDOPNnBig',
    category: 'Blog Comments', // 'Giscus',
    categoryId: 'DIC_kwDOQtP2xM4C0K03', // 'DIC_kwDOPNnBis4CteOc',
