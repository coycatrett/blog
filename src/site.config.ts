...
const config: SiteConfig = {
  ...
  site: 'https://coys-blog.com/',
  // The name of your site, used in the title and for SEO.
  title: 'coy\'s blog',
  // The description of your site, used for SEO and RSS feed.
  description:
    'a blog about math and computer science',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Coy Catrett',
  // Keywords for SEO, used in the meta tags.
  tags: ['coys blog', 'Coy Catrett', 'coycatrett', 'coys-blog', 'Coy', 'Catrett', 'Multiterm'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/coycatrett',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/coycatrett',
    email: 'ctcatrett@gmail.com',
    linkedin: 'https://www.linkedin.com/in/coy-catrett/',
    // mastodon: '',
    // bluesky: '',
    // twitter: '',
